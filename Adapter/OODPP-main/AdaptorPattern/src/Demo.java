//2 interfaces - MediaPlayer(MediaAdapter,AudioPlayer), AdvancedMediaPlayer(Vlcplayer, Mp4player)
//AudioPlayer - can play mp3 format audio files by default.
//AdvancedMediaPlayer -  vlc and mp4 format files.

//want to make AudioPlayer to play other formats as well
